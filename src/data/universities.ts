...
export interface UniversityFeeStructure {
  currency: 'INR' | 'USD';
...
export interface UniversityCampusExperience {
...
export interface UniversityOfficialResources {
...
export interface University {
  ...
  feeStructure: UniversityFeeStructure;
  campusExperience: UniversityCampusExperience;
  officialResources: UniversityOfficialResources;
}

const FEE_DISCLAIMER =
  'Fees shown are estimates for reference. International student fees may differ. Contact Scollarly for your personalised fee breakdown in USD.';
...
export const universities: University[] = [
  {
    ...
    naacGrade: 'A+',
    overview:
      'Chandigarh University is a NAAC A+ ranked private university consistently ranked among India\'s top 25 universities. With 900+ industry partnerships and a vibrant campus of 30,000+ students, it offers a world-class experience with strong placement outcomes.',
    programs: [
    ...
    feeStructure: {
      currency: 'USD',
      tuitionPerYear: { min: 3000, max: 6000 },
      hostelPerYear: { min: 1920, max: 2400 },
      totalCourseRange: { min: 12000, max: 24000 },
      scholarshipAvailable: 'Up to 50% via Scollarly',
      dataConfirmed: true,
    ...
    campusExperience: {
      type: 'iframe_360',
      iframeUrl: 'https://www.iviewd.com/cu2/',
      label: '360° Virtual Campus Tour',
      urlLastChecked: '2026-06-12',
    },
    officialResources: {},
  },
  {
    ...
    overview:
      'Chandigarh Group of Colleges (CGC) University is a leading institution in the Chandigarh tricity area with a strong emphasis on technical education, industry internships, and entrepreneurship. Its campuses host students from over 25 countries.',
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
      { name: 'B.Tech Mechanical Engineering', duration: '4 years' },
      { name: 'B.Tech Civil Engineering', duration: '4 years' },
    ...
    feeStructure: {
      currency: 'INR',
      tuitionPerYear: { min: 0, max: 0 },
      hostelPerYear: { min: 0, max: 0 },
      totalCourseRange: { min: 0, max: 0 },
      scholarshipAvailable: 'Contact Scollarly for details',
      dataConfirmed: false,
      lastUpdated: '2026-06-12',
      disclaimer: FEE_DISCLAIMER,
    },
  ...
  },
  {
    ...
    overview:
      'Swami Vivekanand Group of Institutions is a well-established education group in Chandigarh with multiple campuses. The institution is known for its practical, industry-oriented curriculum and strong faculty with deep professional experience.',
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
      { name: 'B.Tech Mechanical Engineering', duration: '4 years' },
      { name: 'B.Tech Civil Engineering', duration: '4 years' },
  ...
  },
  {
    ...
    feeStructure: {
      currency: 'INR',
      tuitionPerYear: { min: 169000, max: 375000 },
      hostelPerYear: { min: 185000, max: 220000 },
      totalCourseRange: { min: 675000, max: 1500000 },
      scholarshipAvailable: 'Available via Scollarly',
      dataConfirmed: true,
      lastUpdated: '2026-06-12',
      disclaimer: FEE_DISCLAIMER,
    },
    campusExperience: {
      type: 'youtube',
      youtubeId: '5ddvpNEqpec',
      label: 'Official Campus Tour',
      urlLastChecked: '2026-06-12',
    },
    officialResources: {},
  },
  ...
  },
  {
    ...
    overview:
      'Kalinga University is a modern private university in Raipur with a strong technology focus and a multicultural campus community. It offers scholarships to meritorious international students and provides dedicated support for visa and accommodation arrangements.',
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
      { name: 'B.Tech Mechanical Engineering', duration: '4 years' },
      { name: 'B.Tech Civil Engineering', duration: '4 years' },
    ...
    feeStructure: {
      currency: 'INR',
      tuitionPerYear: { min: 105000, max: 155000 },
      hostelPerYear: { min: 78000, max: 286000 },
      totalCourseRange: { min: 421000, max: 621000 },
      scholarshipAvailable: 'Available via Scollarly',
      dataConfirmed: true,
      lastUpdated: '2026-06-12',
      disclaimer: FEE_DISCLAIMER,
    ...
    campusExperience: {
      type: 'iframe_360',
      iframeUrl: 'https://virtualtour.kalingauniversity.ac.in/',
      label: '360° Virtual Campus Tour',
      urlLastChecked: '2026-06-12',
    },
    officialResources: {},
  },
  {
    ...
    overview:
      "Rayat-Bahra University is a private university located in Mohali near Chandigarh with a strong reputation in engineering, pharmacy, and business. The university's international cell provides dedicated support to African students including airport pick-up, hostel allocation, and cultural orientation.",
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
      { name: 'B.Tech Mechanical Engineering', duration: '4 years' },
      { name: 'B.Tech Civil Engineering', duration: '4 years' },
  ...
  },
  {
    ...
    naacGrade: 'A+',
    overview:
      'Aditya University is a NAAC A+ rated institution in Andhra Pradesh with an exceptional track record in engineering and applied sciences. Its state-of-the-art labs, strong industry partnerships, and dedicated placement cell make it a top choice for students targeting technical careers.',
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
  ...
  },
  {
    ...
    overview:
      "CT University in Ludhiana is a dynamic private university known for its industry-connected curriculum and strong alumni network across Punjab's industrial belt. It offers merit scholarships to international students and has a dedicated international student office.",
    programs: [
      { name: 'B.Tech Computer Science & Engineering', duration: '4 years' },
      { name: 'B.Tech Mechanical Engineering', duration: '4 years' },
      { name: 'B.Tech Civil Engineering', duration: '4 years' },
